...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("Drive Train CAN", "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.10986328125);
